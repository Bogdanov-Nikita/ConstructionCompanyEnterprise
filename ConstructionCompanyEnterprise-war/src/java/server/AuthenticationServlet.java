 ...
 * @author nik
 */
@WebServlet(name = "AuthenticationServlet", urlPatterns = {"/user/*"})
@ServletSecurity(@HttpConstraint(rolesAllowed = {"Manager","Master","Client"}))
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/user".equals(request.getServletPath())){
            ...
            if(request.isUserInRole("Master")){
                response.sendRedirect("./master/index.html");
            }
